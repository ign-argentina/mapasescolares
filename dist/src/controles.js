...
$("#mapa").append('<div class="argenmapMapFooter leaflet-bottom leaflet-center"><a style="float:left;" target="_blank" href="http://www.ign.gob.ar/argenmap2/argenmap.jquery/docs"><img src="http://www.ign.gob.ar/argenmap2/argenmap.jquery/img/logoignsintexto-25px.png" style="height: 20px;"></a>');